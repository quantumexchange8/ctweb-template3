        ...
        <section class="py-4">
            <div class="container">
                <div class="d-flex align-items-center">
                    ...
                    <a href="/shopCategories" class="btn btn-light ms-auto rounded-0">View All<i class='bx bx-chevron-right'></i></a>
                </div>
                <hr/>
                <div class="product-grid">
        ...
        <section class="py-4">
            <div class="container">
                <div class="d-flex align-items-center">
                    ...
                    <a href="/blog" class="btn btn-light ms-auto rounded-0">View All News<i class='bx bx-chevron-right'></i></a>
                </div>
                <hr/>
                <div class="product-grid">
