                        ...
                        <div class="col-12 col-xl-9">
                            <div class="product-wrapper">
                                <div class="toolbox d-flex align-items-center mb-3 gap-2">
                                    ...
                                    <div>	<a href="/shopGrid_LeftSidebar" class="btn btn-white rounded-0"><i class='bx bxs-grid me-0'></i></a>
                                    </div>
                                    <div>	<a href="/shopList_LeftSidebar" class="btn btn-light rounded-0"><i class='bx bx-list-ul me-0'></i></a>
                                    </div>
                                </div>
