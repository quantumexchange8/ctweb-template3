        ...
        <div class="container">
            <nav class="navbar navbar-expand">
                ...
                <ul class="navbar-nav ms-auto d-none d-lg-flex">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="/shopCategories">Our Stores</a>
                    </li>
                ...
                <div class="col col-md-auto">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="logo d-none d-lg-flex">
                            <a href="/home">
                                <img src="assets/images/logo.svg" class="logo-icon" alt="" style="width: 60px; height: 60px;"/>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <nav id="navbar_main" class="mobile-offcanvas navbar navbar-expand-lg">
                ...
                <ul class="navbar-nav">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item dropdown-toggle dropdown-toggle-nocaret" href="#">Shop Layouts <i class='bx bx-chevron-right float-end'></i></a>
                                <ul class="submenu dropdown-menu">
                                    <li><a class="dropdown-item" href="/shopGrid_LeftSidebar">Shop Grid - Left Sidebar</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/shopGrid_RightSidebar">Shop Grid - Right Sidebar</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/shopList_LeftSidebar">Shop List - Left Sidebar</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/shopList_RightSidebar">Shop List - Right Sidebar</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/shopGrid_TopFilters">Shop Grid - Top Filter</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/shopList_TopFilters">Shop List - Top Filter</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a class="dropdown-item dropdown-toggle dropdown-toggle-nocaret" href="#">Shop Pages <i class='bx bx-chevron-right float-end'></i></a>
                                <ul class="submenu dropdown-menu">
                                    <li><a class="dropdown-item" href="/shopCart">Shop Cart</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/shopCategories">Shop Categories</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/checkOut_Details">Checkout Details</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/checkOut_Shipping">Checkout Shipping</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/checkOut_Payment">Checkout Payment</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/checkOut_Review">Checkout Review</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/checkOut_Complete">Checkout Complete</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/orderTracking">Order Tracking</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/productComparison">Product Comparison</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a class="dropdown-item" href="/aboutUs">About Us</a>
                            </li>
                            <li><a class="dropdown-item" href="/contactUs">Contact Us</a>
                            </li>
                            <li><a class="dropdown-item" href="/signIn">Sign In</a>
                            </li>
                            <li><a class="dropdown-item" href="/signUp">Sign Up</a>
                            </li>
                            <li><a class="dropdown-item" href="/forgotPassword">Forgot Password</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="/blog">Blog </a> 
                    ...
                    <li class="nav-item"> <a class="nav-link" href="/shopCategories">Our Store</a> 
                    </li>
                    <li class="nav-item dropdown">	<a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">My Account  <i class='bx bx-chevron-down'></i></a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="/downLoads">Downloads</a>
                            </li>
                            <li><a class="dropdown-item" href="/orders">Orders</a>
                            </li>
                            <li><a class="dropdown-item" href="/paymentMethod">Payment Methods</a>
                            </li>
                            <li><a class="dropdown-item" href="/userDetails">User Details</a>
                            </li>
                        </ul>
                    </li>
                </ul>
