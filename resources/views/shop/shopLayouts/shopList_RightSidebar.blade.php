        ...
        <section class="py-3 border-bottom d-none d-md-flex">
            <div class="container">
                <div class="page-breadcrumb d-flex align-items-center">
                    <h3 class="breadcrumb-title pe-3">Shop List Right Sidebar</h3>
                    <div class="ms-auto">
                    ...
                    <div class="col-12 col-xl-9 order-1">
                        <div class="product-wrapper">
                            <div class="toolbox d-flex align-items-center mb-3 gap-2">
                                ...
                                <div>	<a href="/shopGrid_RightSidebar" class="btn btn-light rounded-0"><i class='bx bxs-grid me-0'></i></a>
                                </div>
                                <div>	<a href="/shopList_RightSidebar" class="btn btn-white rounded-0"><i class='bx bx-list-ul me-0'></i></a>
                                </div>
                            </div>
